!(function (r) {
    ...
    (t.prototype.generateData = function () {
        for (var t = [], a = 0; a < 100; a++)
            t.push(5e3 + 1e5 * Math.random() + 0.8 * a * a * a);
        return t;
    }),
        (t.prototype.init = function () {
            ...
            for (t = 0; t < 100; t++) {
                ...
                this.yearBalanceData.push([
                    a.setDate(a.getDate() + 365 * t - 36500),
        ...
        (t.prototype.initCurrencyBTC = function () {
            ...
            new ApexCharts(
                document.querySelector("#currency-btc-chart"),
                e
            ).render();
        }),
        (t.prototype.initCurrencyCNY = function () {
            ...
            new ApexCharts(
                document.querySelector("#currency-cny-chart"),
                e
            ).render();
        }),
        (t.prototype.initCurrencyETH = function () {
            ...
            new ApexCharts(
                document.querySelector("#currency-eth-chart"),
                e
            ).render();
        }),
